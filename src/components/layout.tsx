...
export default function Layout() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 items-start md:min-h-screen lg:min-h-[80vh] px-4 max-[1550px]:px-10 min-[1550px]:px-42 py-8 gap-4 md:gap-8">
      <div className="md:flex flex-col justify-between bg-background md:ms-15 md:mt-5">
        ...
        <p className=" mx-4 text-center md:text-base text-secondary max-w-md">
          Crie sua conta para agendar consultas e exames com médicos
          especialistas.
        </p>
      </div>
